...
# Run inference
python infer.py --text "Hello world" --voice preset_english_1
```

And here's some Python code:

```python
from voxtral import VoxtralModel

model = VoxtralModel.from_pretrained("mistralai/voxtral-4b")
audio = model.synthesize("Welcome to Voxtral", language="en")
